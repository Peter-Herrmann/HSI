...
synth_design -top breadboard_test -part xc7a15tftg256-1
...
write_checkpoint -force -noxdef breadboard_test.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file breadboard_test_utilization_synth.rpt -pb breadboard_test_utilization_synth.pb"  } 
