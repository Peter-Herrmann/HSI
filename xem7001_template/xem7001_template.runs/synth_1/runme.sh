...
HD_PWD='C:/Users/PeterHerrmann/Code/HSI/xem7001_template/xem7001_template.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log breadboard_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source breadboard_test.tcl
