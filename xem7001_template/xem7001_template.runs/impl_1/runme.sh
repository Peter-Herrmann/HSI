...
HD_PWD='C:/Users/PeterHerrmann/Code/HSI/xem7001_template/xem7001_template.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log breadboard_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source breadboard_test.tcl -notrace
